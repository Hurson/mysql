...
@Repository
public class DUixDaoImpl extends BaseDaoImpl implements DUixDao {

	public int getUiVersion(String areaCode, Integer type) {
		
		List resultList = this.getHibernateTemplate().find("from DUixVersion uv where uv.areaCode=? and uv.updateType=?", areaCode, type);
