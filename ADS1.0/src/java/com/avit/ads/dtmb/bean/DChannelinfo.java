...
public class DChannelinfo implements java.io.Serializable {

	private static final long serialVersionUID = 2406194736382797320L;
	// Fields
	@Id
	...
	/** full constructor */
	public DChannelinfo(Long channelId, String channelCode,
	...
	public DChannelinfo(String channelName, String channelCode, String serviceId) {
		super();
		this.channelCode = channelCode;
		this.channelName = channelName;
		this.serviceId = serviceId;
