...
public class ChannelInfoSync implements java.io.Serializable {
	...
	/** default constructor */
	public ChannelInfoSync() {
	}


	/** full constructor */
	public ChannelInfoSync(Long channelId, String channelCode,
	...
	public ChannelInfoSync(String channelName, String channelCode, String serviceId) {
		super();
		this.channelCode = channelCode;
		this.channelName = channelName;
		this.serviceId = serviceId;
