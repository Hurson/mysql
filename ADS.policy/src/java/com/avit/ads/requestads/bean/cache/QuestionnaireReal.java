...
/**
 * QuestionnaireReal entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "T_QUESTIONNAIRE_REAL")
public class QuestionnaireReal implements java.io.Serializable {
	...
	/** default constructor */
	public QuestionnaireReal() {
	}

	/** minimal constructor */
	public QuestionnaireReal(long id) {
		this.id = id;
	}

	/** full constructor */
	public QuestionnaireReal(long id, String name, String description,
