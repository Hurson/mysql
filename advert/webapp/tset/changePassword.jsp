           ...
           <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="list">
            ...
            <tr>
             ...
             <tr>
                 <td align="center">&nbsp;</td>
                 <td align="left"> 
                      <s:text name="user.new.password.check" />:
                 </td>
                 <td>
              ...
              <tr>
                  ...
                  <td align="left">
                      &nbsp;
                      <input class="btn_big" type="button"  onclick="resetAllPassword('queryForm');"
                                               value='<s:property value="%{getText('user.reset')}"/>' />
                  </td>
                  <td></td>
                </tr>
             </table>
