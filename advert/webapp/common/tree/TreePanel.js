...
TreePanel = function(config){
	...
	this.iconPath = getContextPath()+'/tset/common/tree/img/'; /** chennaidong --  **/
	this.clickListeners = [];
	this.element = document.createElement('div');
	/** chennaidong -- update **/
	this.element.id='TreePanel_id';

	//this.element.style.display="none";
	/** chennaidong -- end **/
	this.element.className='showDiv';
...
/*		this.container = (String.isInstance(renderTo) ? document.getElementById(renderTo) : renderTo ) || document.body;*/
		this.container = document.getElementById("treeList");
