...
<table cellspacing="1" class="searchList" >
	...
	<s:iterator value="page.dataList" status="status" var="order">
		<tr <s:if test="#status.index%2==1">class="sec"</s:if>
			...
			<td><a href="getOrderAuditDetail.do?order.id=<s:property value='#order.id' />"><s:property value="#order.orderCode" /></a></td>
			...
			<td>
				<s:if test="#order.orderType==0">投放式</s:if>
				<s:elseif test="#order.orderType==1">请求式</s:elseif>
			</td>
		</tr>
	</s:iterator>
  <tr>
