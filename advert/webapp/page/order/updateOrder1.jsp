...
<script type="text/javascript">
	...
	function init(materialJson,adPackageType,ployJson,positionJson,time){
		aheadTime = time;
...
<body class="mainBody" onload='init(${materialJson},${adPackageType},${ployJson},${positionJson},${aheadTime});'>
...
<table cellspacing="1" class="searchList" align="left">
	...
	<tr>
		...
		<ul>
			<!-- <li>已选择策略</li>
			<div id="selPloy"><span id="selPloyName">${order.ployName}</span> 
			<span id="ploybd"> 
				<a href="javascript:showContent('resource',0);" style="diplay: block; float: right;">绑定素材</a> 
			</span> <br />
