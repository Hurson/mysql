...
<script type="text/javascript">
	...
	function save() {
	   ...
	   for(var i = 0; i<idsArray.length; i++){  
		   ...
		   /*
		   var ay=idsArray[i].split("_");	
		    var Name="";	 
		   if(idsArray[i].split("_")[2]!=null){
		     for(var n=2;n<=ay.length-1;n++){
		     Name=Name+"_"+idsArray[i].split("_")[n];
		   }
		   //var resourceName = idsArray[i].split("_")[1]+"_"+idsArray[i].split("_")[2];
		   var resourceName = idsArray[i].split("_")[1]+Name;
		   }else{
