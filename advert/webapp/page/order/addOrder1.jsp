...
<table cellspacing="1" class="searchList" align="left">
	...
	<tr>
		...
		<ul>
			<!-- <li>已选择策略</li>
			<div id="selPloy"><span id="selPloyName"></span> <span id="ploybd" style="display: none"> 
				<a href="javascript:showContent('resource',0);" style="diplay: block; float: right;">绑定素材</a> </span> <br />
