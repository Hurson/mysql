...
function query() {
       ...
       if(validateSpecialCharacterAfter(document.getElementById("meterialQuery.resourceName").value)){
		...
		//if(validateSpecialCharacterAfter(document.getElementById("meterialQuery.contractName").value)){
			//alert("合同名称不能包括特殊字符！");
			//return ;
		//}
 ...
 function deleteData() {
  ...
  function modifyData(materialId) {
      window.location.href="<%=path %>/page/meterial/initMaterial.do?materialId="+materialId;
    }
...
<table cellspacing="1" class="searchList">
  ...
  <tr>
    <td class="searchCriteria">
                  ...
                  <!-- 
                  <span>合同名称：</span>
                  <input type="text" name="meterialQuery.contractName" id="meterialQuery.contractName" value="${meterialQuery.contractName}"/>
                   -->
