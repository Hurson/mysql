...
<body
	onload='init(${orderJson},${contractJson },${positionJson },${ployJson },${plMJson },${prMJson},"<%=ConfigureProperties.getInstance().get("orderOpAheadTime")%>");'>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="1" width="100%" class="tablea">
			...
			<tr>
				...
				<td class="td_inputz">
					<input type="hidden" id="orderState" value="${state }"/>
					<span class="e_input_text" id="orderNo"></span>
				</td>
			...
			<tr>
				...
				<td class="td_inputz"><input id="ployName" class="e_input_add" readonly="readonly"
					...
					onclick="showPloy();" onblur="this.className='e_input_add'" />
					<span style="color:red">*</span>	
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<table cellpadding="0" cellspacing="1" width="100%" class="tablea">
					<tr>
						...
						<ul>
							<li>已选择策略</li>
							<div id="selPloy"><span id="selPloyName"></span> <span id="ploybd"> <a
					...
					<tr>
						...
						<!--<input type="button" title="大图预览" onclick="" class="b_preview" value=""
							onfocus="blur()" />--> 
						...
						<input type="button" title="保存" onclick="saveOrder();" class="b_baoc" value="" onfocus="blur()" />
						<input type="button" title="重置" onclick='init(${orderJson},${contractJson },${positionJson },${ployJson },${plMJson },${prMJson});' 
...
<table cellpadding="0" cellspacing="1" width="100%" class="tableDiv">
	...
	<tr>
		...
		<td class="td_input"><input type="text" readonly="readonly" id="cStart"
			class="time_inputDiv" /></td>
		<td class="td_label">结束时间：</td>
		<td class="td_input"><input type="text" readonly="readonly" id="cEnd"
			class="time_inputDiv" /></td>
