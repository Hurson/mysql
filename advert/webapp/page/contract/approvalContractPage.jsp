...
<script type="text/javascript" src="<%=path%>/js/contract/approvalContract.js"></script>
									...
									<td style="padding:1px;">
										<table cellpadding="0" cellspacing="1" width="100%" class="tablea" >
											...
											<tr>
												...
												<td class="td_input">	   
													<textarea id="examinationOpinions" name="contract.examinationOpinions" value="${contract.examinationOpinions}" style="overflow:hidden;padding:0;width:323px;height:125px;border:1px solid gray;">		
													</textarea>
												</td>
											</tr>
											<tr>
												...
												<td class="td_input" colspan="3">	   
													<input id="status" name="contract.status" type="radio" value="1" />&nbsp;&nbsp;&nbsp;审核  通过&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<input id="status" name="contract.status" type="radio" value="2" />&nbsp;&nbsp;&nbsp;审核不通过
												</td>
					...
					<table cellpadding="0" cellspacing="1" width="100%" class="binding_taba_right_list" id="bm">
						...
						<tr>
							<td class="formBottom" colspan="99" style="text-align: right;">
							 	<input type="button" value="提交" id="approvalContractButton" name="approvalContractButton"/>
							</td>
						</tr>
					</table>
				</div>
