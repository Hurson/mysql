...
<body class="mainBody">
<form action="queryWeekReportList.do" method="post" id="queryForm">
...
<table cellspacing="1" class="searchList">
  ...
  <tr>
    <td class="searchCriteria">
      ...
      <span>开始时间：</span>
	   	<!-- <input id="beginTime" name="report.pushDateStart" value="${report.pushDateStart}" type="text" readonly="readonly" style="width:  120px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" />
