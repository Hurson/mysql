...
function query() {
 ...
 function addData() {
      window.location.href="<%=path%>/page/channelGroup/intoAddChannelGroupNpvr.do";
    }
 function deleteDatas() {
     ...
     if (confirm("您确定删除所选的频道组吗？")) {
             ...
             document.forms[0].action="<%=path %>/page/channelGroup/deleteChannelGroupNpvr.do";
             document.forms[0].submit();
	    }
...
function modifyChannelGroupRef(channelGroupId) {
    ...
    function modifyData(channelGroupId) {
      window.location.href="<%=path %>/page/npvrChannelGroup/initChannelGroupNpvr.do?channelGroupId="+channelGroupId;
    }
</script>
<style>
...
<body class="mainBody">
 <form action="<%=path %>/page/channelGroup/queryChannelGroupListNpvr.do" method="post" id="queryForm">
 <!-- 
...
<div class="search">
<div class="path">首页 >> 系统管理 >> 回看频道组维护</div>
