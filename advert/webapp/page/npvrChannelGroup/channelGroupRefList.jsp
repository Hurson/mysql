...
function query() {
 ...
 function addData() {
    var channelGroupId=document.getElementById("channelGroupId").value;
		...
		var structInfo = "";
		    ...
		    structInfo+="<iframe id='selectChannelFrame' name='selectChannelFrame'  frameBorder='0' width='1000px' height='500px'  scrolling='yes'  align='top' src='<%=request.getContextPath()%>/page/channelGroup/selectChannelNpvr.do?channelGroupId="+channelGroupId+"'></iframe>";
		    structInfo+="</div>";
 ...
 function deleteDatas() {
     ...
     if (confirm("您确定删除所选吗？")){
          ...
          document.forms[0].action="<%=path %>/page/channelGroup/deleteChannelGroupRefNpvr.do";
          document.forms[0].submit();
     }
    ...
    function goback() {
    window.location.href="<%=path%>/page/channelGroup/queryChannelGroupListNpvr.do"; 
    }
    ...
    function test(){
    	var channelGroupId=document.getElementById("channelGroupId").value;
       	window.location.href="<%=path%>/page/channelGroup/queryChannelGroupRefListNpvr.do?channelGroupId="+channelGroupId;
    }
</script>
<style>
...
<body class="mainBody">
 <form action="<%=path %>/page/channelGroup/queryChannelGroupRefListNpvr.do" method="post" id="queryForm">
...
<div class="search">
<div class="path">首页 >> 系统管理 >> 回看频道组维护>> 关联频道</div>
