...
var selectData="";
	function selectChannel(){
    	...
    	document.forms[0].action="<%=path %>/page/channelGroup/saveChannelGroupRefNpvr.do?channelGroupId="+i;
...
<body class="mainBody">
<form action="<%=path %>/page/channelGroup/selectChannelNpvr.do" method="post" id="queryForm">
...
<div class="search">
        <div class="path">首页 >> 系统管理 >>回看频道组管理>>关联频道&gt;&gt;选择频道</div>
