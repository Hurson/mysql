...
<body>
<form  id="form" action="userRank_list.do" method="post" id="userArea_list" name="userArea_list"> 
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="1" width="100%" class="tablea">
			<tr>
				<td class="formTitle" colspan="99"><span>用户级别管理</span></td>
			</tr>
			<tr>
			    <td class="td_label">用户级别编码:</td>
				<td class="td_input"><input type="text" class="e_input" name="userRank.userRankCode" onblur="this.className='e_input'" onfocus="this.className='e_inputFocus'"/></td>
			    <td class="td_label">用户级别名称：</td>
				<td class="td_input"><input type="text" class="e_input" name="userRank.userRankName" onblur="this.className='e_input'" onfocus="this.className='e_inputFocus'"/></td>
			</tr>
			<tr>
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="1" width="100%" class="taba_right_list" id="bm">
			...
			<tr>
				...
				<td  height="26px" align="center">用户级别编码</td>
				<td  height="26px" align="center">用户级别名称</td>
			</tr>
			<s:if test="listUserRank.size==0">
			<tr>
		...
		<c:set var="index" value="0"/>
			<s:iterator value="listUserRank" status="rowstatus" var="item">
				<tr>
					<td align="center">${rowstatus.count}</td>
					<td align="center"><s:property value="userRankCode"/></td>
					<td align="center"><s:property value="userRankName"/></td>
				</tr>
					...
					<a href="#">当前第${page.pageNo }/${page.totalPage }页</a>&nbsp;&nbsp;
						<c:choose>
							<c:when test="${page.pageNo==1&&page.totalPage!=1}">
								【<a href="userRank_list.do?pageNo=${page.pageNo+1 }">下一页</a>】&nbsp;&nbsp;
								【<a href="userRank_list.do?pageNo=${page.totalPage}">末页</a>】&nbsp;&nbsp;
							</c:when>
							<c:when test="${page.pageNo==page.totalPage&&page.totalPage!=1 }">
								【<a href="userRank_list.do?pageNo=1">首页</a>】&nbsp;&nbsp;
								【<a href="userRank_list.do?pageNo=${page.pageNo-1 }">上一页</a>】&nbsp;&nbsp;
							</c:when>
