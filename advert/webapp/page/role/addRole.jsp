		    	...
		    	<table>
		    		<tr>
			            ...
			            <tr>
			                ...
			                <td width="35%">
				              	<input id="role_des" name="role.description" type="text" maxlength="80"/>
			                </td>
			            </tr>		     
			             <tr>
						...
						<td width="35%">
						<!--  <input id="role_columns" class="e_input_add"
							onfocus="this.className='e_inputFocus'"
							onclick="fillColumnInfo_2();" onblur="this.className='e_input_add'" 
							/>  -->
