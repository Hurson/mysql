 ...
 function addData() {
    ...
    var channelGroupType=document.getElementById("channelGroupType").value;
		var structInfo = "";
		    ...
		    structInfo+="<iframe id='selectChannelFrame' name='selectChannelFrame'  frameBorder='0' width='1000px' height='500px'  scrolling='yes'  align='top' src='<%=request.getContextPath()%>/dchannelGroup/selectChannel.do?channelGroupId="+channelGroupId+"&channelGroupType="+channelGroupType+"'></iframe>";
		    structInfo+="</div>";
