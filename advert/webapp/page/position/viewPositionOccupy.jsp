...
<body class="mainBody">
<form action="viewPositionOccupy.do" method="post" id="queryForm">
	...
	<input type="hidden" id="id" name="contractAD.positionId" value="${contractAD.positionId}"/>
	<div class="search">
		  ...
		  <tr>
		    <td class="searchCriteria">
		      <span style="width: 60px;text-align:right;">开始日期：</span>
			   	<input id="startDateStr" name="contractAD.startDateStr" value="${contractAD.startDateStr}" type="text" readonly="readonly" style="width:  100px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
			  ...
			  <span style="width: 60px;text-align:right">结束日期：</span>
			    <input id="endDateStr" name="contractAD.endDateStr" value="${contractAD.endDateStr}" type="text" readonly="readonly" style="width:  100px" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" />
