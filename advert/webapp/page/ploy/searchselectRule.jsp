...
<script type="text/javascript">
   ...
   function selectrule(pradiovalue){
    	
    	parent.document.getElementById("rule.marketingRuleName").value=pradiovalue;
...
<form action="<%=path %>/page/ploy/queryRuleList.do" method="post" id="queryForm">
        ...
        <td width="30%" align="center">结束时间</td>
                    ...
                    <c:forEach items="${pageRule.dataList}" var="prule" varStatus="pc">
                        <tr <c:if test="${pc.index%2==1}">class="sec"</c:if>>
                            <td>
                                <input type="radio" name="contractid" value="合同2" onclick="selectrule('${prule.marketingRuleName}');">
                             </td>
                            <td>
