...
<script type="text/javascript">
    ...
    function selectcontract(contractName,contractId){
    	...
    	window.dialogArguments.document.getElementById("ploy.contractName").value=contractName;
    	window.dialogArguments.document.getElementById("ploy.contractId").value=contractId;
    //	parent.document.getElementById("ploy.ruleName").value="";
   // 	parent.document.getElementById("ploy.ruleId").value="";
    	window.dialogArguments.document.getElementById("ploy.positionName").value="";
    	window.dialogArguments.document.getElementById("ploy.positionId").value="";
...
<form action="<%=path %>/page/ploy/addqueryContractList.do" method="post" id="queryForm">
...
<div class="search">
<div class="path">首页 >> 投放策略管理 >> 策略维护>>选择合同</div>
