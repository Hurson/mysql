...
function query() {
 ...
 function deleteData() {
  ...
  function modifyData(ployid, channelGroupType) {
      window.location.href="<%=path %>/page/ploy/getCheckPloyById.do?ployId="+ployid+"&channelGroupType="+channelGroupType;
...
<body class="mainBody">
 <form action="<%=path %>/page/ploy/queryCheckPloyList.do" method="post" id="queryForm">
...
<table cellspacing="1" class="searchList">
    <tr class="title">
        <td width="33%" align="center">策略名称</td>
        <td width="33%" align="center">广告商</td>
        <td width="33%" align="center">广告位</td>
                    ...
                    <c:forEach items="${pagePloy.dataList}" var="ployInfo" varStatus="pl">
                        <tr <c:if test="${pl.index%2==1}">class="sec"</c:if>>
                             <td align="center">
                                <a href="javascript:modifyData('${ployInfo.ployId}','${ployInfo.channelGroupType}');">${ployInfo.ployName}</a>
                            </td>
