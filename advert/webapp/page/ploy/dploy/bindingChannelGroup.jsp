...
<body class="mainBody">
 <form action="<%=path %>/dploy/queryChannelGroupList.action" method="post" id="queryForm">
...
<table cellspacing="1" class="searchList">
    <tr class="title">
        ...
        <td width="30%" align="center">分组描述</td>
                    ...
                    <c:forEach items="${page.dataList}" var="groupInfo" varStatus="pl">
                        <tr <c:if test="${pl.index%2==1}">class="sec"</c:if>>
                            <td>
                                <input id="data_${groupInfo.id}" type="checkbox" value="<c:out value='${groupInfo.id}|${groupInfo.name}'/>" name="dataIds"/>
                             </td>
                            <td width="30%" >
                               ${groupInfo.name}
                            </td>
