...
<table cellspacing="1" class="searchList">
    <tr class="title">
        ...
        <td width="30%" align="center">价格</td>
                    ...
                    <c:forEach items="${page.dataList}" var="indInfo" varStatus="pl">
                        <tr <c:if test="${pl.index%2==1}">class="sec"</c:if>>
                            <td>
                                <input id="data_${indInfo.userIndustryCategoryCode}" type="checkbox" value="<c:out value='${indInfo.userIndustryCategoryCode}|${indInfo.userIndustryCategoryValue}'/>" name="dataIds"/>
                             </td>
                            <td width="30%" >
