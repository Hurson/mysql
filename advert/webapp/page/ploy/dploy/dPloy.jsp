...
function addselectContract() {
	...
	//	});
	 ...
	 function changePosition(){
		 ...
		 var positionCode = $("#ploy.positionCode").val();
  ...
  <tr>
    <td class="searchCriteria">
      <span>*投放策略名称：</span>
               ...
               <select id="ploy.positionCode" name="ploy.positionCode" onchange="changePosition(this.value);"  <c:if test="${ploy.ployId > 0}"> disabled="disabled" </c:if> >
