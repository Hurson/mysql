...
function  refreshSelectList()
{
	...
	var optionSelelct =window.dialogArguments.document.getElementsByName("bchannelgroup");
...
function selectData(){
    	...
    	for (var i=0;i<strdatas.length;i++)	{
	       ...
	       if (!flag){
	        	window.dialogArguments.add_bchannelgroup('contenttable15',dataPropertys[0],dataPropertys[1]);
	        }
...
<body class="mainBody">
 <form action="<%=path %>/page/precise/queryBChannelGroup.do" method="post" id="queryForm">
