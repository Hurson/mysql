...
function selectData(){
    	...
    	for (var i=0;i<strdatas.length;i++)	{
	       ...
	       if (!flag){
	        	window.dialogArguments.addNpvrChannelGroup('contenttable5',dataPropertys[0],dataPropertys[1]);
	        }
...
{
	window.dialogArguments.window.parent.parent.parent.frames["leftFrame"].openPage('/page/npvrChannelGroup/queryChannelGroupListNpvr.do', '19', '回看频道组管理', '回看频道组管理');
...
<body class="mainBody">
 <form action="<%=path %>/page/precise/queryNpvrChannelGroup.do" method="post" id="queryForm">
...
<table cellspacing="1" class="searchList">
  ...
  <tr>
    <td class="searchCriteria">
      <span>频道分组名称：</span><input onkeypress="return validateSpecialCharacter();" type="text" name="npvrChannelGroup.name"  value="${npvrChannelGroup.name}"/>
