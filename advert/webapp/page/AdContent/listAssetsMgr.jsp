...
<link rel="stylesheet" href="<%=path %>/css/popUpDiv.css">
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<tr>
		...
		<table cellpadding="0" cellspacing="1" width="100%" class="tablea">
			<tr>
				<td class="formTitle" colspan="99"><span>广告资产管理</span></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="td_input"><input type="text" name="resource.createTimeA"   id="startTime"  readOnly="true" class="e_inputTime" onfocus="this.className='e_inputFocusTime'" onblur="this.className='e_inputTime'" />~<input type="text" name="resource.createTimeB"  id="endTime"  readOnly="true" class="e_inputTime" onfocus="this.className='e_inputFocusTime'" onblur="this.className='e_inputTime'"/></td>
			</tr>
			...
			<tr>
				...
				<input type="button" title="添加" class="b_add" onfocus=blur() id="bt1" onclick="goMetaRedirect()" /> 
			</tr>
		</table>
		</form>
		</td>
		...
		<c:set var="index" value="0"/>
			<s:iterator value="listAdAssetResource" status="rowstatus" var="item">
				<tr>
					...
					<td align="center">
					    <input type="button" title="修改" class="button_halt" onclick="goUpdateMetaRedirect(<s:property value='id'/>,<s:property value='resourceType'/>,<s:property value='resourceId'/>,<s:property value='state'/>)" />
						<input type="button" title="删除" class="button_delete"  onclick="goDeleteInfo(<s:property value='id'/>,<s:property value='resourceType'/>,<s:property value='resourceId'/>,<s:property value='state'/>)" />
					</td>
				</tr>
			...
			<td>    
				<input class="btn" type="button" value="删除"  title="删除"  onclick="goDeleteAbatch()" />
			 </td>   
			 <td>   
			    <input class="btn" type="button" value="添加"  title="添加"  onclick="goMetaRedirect()" />
			</td>
