...
<body>
  ...
  <div id="upMeterialInfo" class="showDiv" style="display:none">
	<table cellpadding="0" cellspacing="0" style="margin-top: 0; width: 760px; height: 336px; border: 1px solid #cccccc; font-size:12px;background-color:#cccccc; ">
		<tr class="list_title">
			<td style="border: 0; padding-left:5px;" align="center">素材上线操作</td>
		...
		<tr>
			<td colspan="2" class="td_bottom">
				<div class="buttons">
					<a href="javascript:SubmitUpOpintions()">确认</a>
					<a href="javascript:closeUpResource()">返回</a>
				</div>		
			</td>
		</tr>
	</table>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	...
	<form>
		...
		<c:set var="index" value="0"/>
			...
			<td>    
				<input class="btn" type="button" value="上线"  title="上线"  onclick="goUpInfo()" />
			 </td>   
			 <td>   
			    <input class="btn" type="button" value="下线"  title="下线"  onclick="goDownInfo()" />
			</td>
