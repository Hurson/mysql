package com.dvnchina.advertDelivery.utils.json;
...
public class Obj2JsonUtil {
  ...
  public static String object2json(Object obj) {
    ...
    if (obj == null) {
    ...
    }else if (obj instanceof String || obj instanceof BigDecimal || obj instanceof BigInteger || obj instanceof Byte 
      ...
      json.append(set2json((Set<?>) obj));
	    ...
	    json.append("\"");
	    json.append(string2json(Transform.CalendartoString((java.util.Date)obj)));
	    json.append("\"");
    }else {
