		...
		if (ploy==null)
		{
	 	...
	 	if (ploy.getState().equals("1"))
	 	{
            ...
            " from t_ploy_backup t where t.ploy_id="+ploy.getPloyId();
	 		...
	 		",DTV_CHANNEL_ID,PLAYBACK_CHANNEL_ID,LOOKBACK_CATEGORY_ID,USER_AREA,USER_AREA2,USER_AREA3,USERINDUSTRYS,USERLEVELS,TVN_NUMBER,Priority,Ploy_Id,CHANNEL_GROUP_ID,TVN_EXPRESSION,menu_type_code)"+
			" select "+
			...
			",t.LOOKBACK_CATEGORY_ID,t.USER_AREA,t.USER_AREA2,t.USER_AREA3,t.USERINDUSTRYS,t.USERLEVELS,t.TVN_NUMBER,t.Priority,t.Ploy_Id,t.CHANNEL_GROUP_ID,t.TVN_EXPRESSION,t.menu_type_code"+
