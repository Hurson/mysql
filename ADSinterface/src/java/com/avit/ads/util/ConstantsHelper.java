...
public class ConstantsHelper {
    ...
    public static String CMA_DATA_PATH="cma_data_path";
    public static String CMA_DATA_BACKUPPATH="cma_data_backuppath";
    public static String ZIP_FLAG="hnreport_";
    public static String ACTION_FLAG="action_";
    public static String BOOT_FLAG ="boot_";
    public static String CMA_LUCENE_SIZE="cma_lucene_size";
}
