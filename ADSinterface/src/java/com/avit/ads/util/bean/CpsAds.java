...
public class CpsAds {
	...
	@XmlAttribute(name="adsImageTargetPath")
	private String adsImageTargetPath;	
	...
	public String getAdsImageTargetPath() {
		return adsImageTargetPath;
	}
	public void setAdsImageTargetPath(String adsImageTargetPath) {
		this.adsImageTargetPath = adsImageTargetPath;
	}
